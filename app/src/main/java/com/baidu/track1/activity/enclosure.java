package com.baidu.track1.activity;
...
import com.baidu.track1.TrackApplication;
import com.baidu.track1.dialog.Create2;
import com.baidu.track1.model.Locate;
import com.baidu.track1.utils.AbstractFenceListener;
import com.baidu.track1.utils.BitmapUtil;
import com.baidu.track1.utils.CommonUtil;
import com.baidu.track1.utils.Constants;
import com.baidu.track1.utils.MapUtil;
import com.baidu.track1.utils.NetUtil;
import com.baidu.track1.utils.TrackReceiver;
import com.baidu.track1.utils.ViewUtil;

import java.util.ArrayList;
import java.util.List;

public class enclosure extends BaseActivity implements View.OnClickListener, SensorEventListener, BaiduMap.OnMarkerClickListener {
     ...
     * 围栏创建对话框
     */
    private Create2 fenceCreateDialog2 = null;
     ...
     * 围栏创建对话框回调接口
     */
    private Create2.Callback createCallback = null;
  ...
  int load=0;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        load = soundPool.load(this, R.raw.shot, 1);
    }
    ...
    private void initView() {
        ...
        traceBtn = (Button) findViewById(R.id.trace);
        gatherBtn = (Button) findViewById(R.id.gather);
    ...
    private void initListener() {
        ...
        //对话框回调
        createCallback = new Create2.Callback() {

            @Override
            public void onSureCallback(double radius, int denoise, int offset) {

                enclosure.this.radius = radius;
        ...
        fenceListener = new AbstractFenceListener() {
            ...
            public void onDeleteFenceCallback(DeleteFenceResponse deleteFenceResponse) {
                ...
                if (deleteFenceResponse.getStatus() == StatusCodes.SUCCESS) {
                    viewUtil.showToast(enclosure.this,
                            "围栏旧删除成功");
                }
        ...
        trackListener = new OnTrackListener() {
            ...
            public void onLatestPointCallback(LatestPointResponse response) {
                ...
                try {
                    ...
                    if(firstLocate){
                        firstLocate = false;
                        Toast.makeText(enclosure.this,"起点获取中，请稍后...",Toast.LENGTH_SHORT).show();
                        return;
                    }

                    //当前经纬度
                    Locate.locTime = point.getLocTime();
                    Locate.latitude = currentLatLng.latitude;
                    Locate.longitude = currentLatLng.longitude;
        ...
        entityListener = new OnEntityListener() {
            ...
            public void onReceiveLocation(TraceLocation location) {
                ...
                try {
                    ...
                    Locate.locTime = CommonUtil.toTimeStamp(location.getTime());
                    Locate.latitude = currentLatLng.latitude;
                    Locate.longitude = currentLatLng.longitude;
        ...
        traceListener = new OnTraceListener() {
            ...
            public void onPushCallback(byte messageType, PushMessage pushMessage) {
                ...
                if (messageType < 0x03 || messageType > 0x04) {
                    viewUtil.showToast(enclosure.this, pushMessage.getMessage());
                    return;
                }
    ...
    private void showDialog() {
        if (null == fenceCreateDialog2) {
            fenceCreateDialog2 = new Create2(enclosure.this, createCallback);//创建dialog
        }
    ...
    public void onSensorChanged(SensorEvent sensorEvent) {
        ...
        if (Math.abs(x - lastX) > 1.0) {// 方向改变大于1度才设置，以免地图上的箭头转动过于频繁
            ...
            if (!CommonUtil.isZeroPoint(Locate.latitude, Locate.longitude)) {
                mapUtil.updateMapLocation(new LatLng(Locate.latitude, Locate.longitude), (float) mCurrentDirection);
            }
        }
        lastX = x;
