...
import com.baidu.track1.dialog.Create1;
import com.baidu.track1.dialog.Operate;
 ...
 */
public class CreaFence extends BaseActivity implements View.OnClickListener,
    ...
    private Create1 fenceCreateDialog = null;//围栏创建对话框

    private Create1.Callback createCallback = null;//围栏创建对话框回调接口
    private Operate fenceOperateDialog = null;//围栏操作对话框（查询历史报警、删除、更新）
    ...
    private void initMap() {
        ...
        fenceOperateDialog = new Operate(this);
    ...
    public void onClick(View view) {
        ...
        switch (view.getId()) {
            ...
            case R.id.btn_activity_options:
                Intent intent = new Intent(CreaFence.this,CreaFenchoice.class);
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        switch (operateType) {
            case R.id.btn_create_fence:
                mapUtil.baiduMap.setOnMapClickListener(CreaFence.this);
                break;
    ...
    public void onMapClick(LatLng latLng) {
        ...
        if (null == fenceCreateDialog) {
            fenceCreateDialog = new Create1(this, createCallback);
        }
    ...
    private void initListener() {
        ...
        createCallback = new Create1.Callback() {

            private int tag;

            @Override
            public void onSureCallback(double radius, int denoise, int offset) {
                CreaFence.this.radius = radius;
                CreaFence.this.denoise = denoise;
                CreaFence.this.offset = offset;
        ...
        fenceListener = new OnFenceListener() {
            ...
            public void onCreateFenceCallback(CreateFenceResponse response) {
                ...
                if (StatusCodes.SUCCESS == response.getStatus()) {
                    ...
                    viewUtil.showToast(CreaFence.this,
            ...
            public void onDeleteFenceCallback(DeleteFenceResponse response) {
                viewUtil.showToast(CreaFence.this, response.getMessage());
            ...
            public void onFenceListCallback(FenceListResponse response) {
                ...
                if (0 == response.getSize()) {
                    ...
                    viewUtil.showToast(CreaFence.this, message.toString());

                    return;
                }

                viewUtil.showToast(CreaFence.this, getString(R.string.fence_operate_caption));
