...
public class district extends Activity implements OnGetDistricSearchResultListener, Button.OnClickListener {
    ...
    private Button mSearchButtonreturn;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mSearchButtonreturn= (Button) findViewById(R.id.districSearch_return);
        mSearchButtonreturn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent=new Intent(district.this,MainActivity.class);
