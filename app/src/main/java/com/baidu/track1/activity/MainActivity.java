    ...
    private void init() {
        ...
        enclosure.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(MainActivity.this, com.baidu.track1.activity.enclosure.class);
        ...
        district.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(MainActivity.this, com.baidu.track1.activity.district.class);
                startActivity(intent);
            }
        });
