...
import static com.baidu.track1.utils.BitmapUtil.bmEnd;
import static com.baidu.track1.utils.BitmapUtil.bmStart;
...
public class MapUtil {
    ...
    public void setCenter(float direction) {
        if (!CommonUtil.isZeroPoint(Locate.latitude, Locate.longitude)) {
            LatLng currentLatLng = new LatLng(Locate.latitude, Locate.longitude);
